package net.manal.billingservice;
...
import net.manal.billingservice.model.Customer;
import net.manal.billingservice.model.Product;
	...
	CommandLineRunner commandLineRunner(BillRepository billRepository,
		...
		return args -> {
			try {
				...
				System.err.println("Warning: Could not initialize Billing data automatically: " + e.getMessage());
			}
		};
	}
